...
class Symbol
{
	const BUTTER_CASH_SETTLED = 'BUTTER (CASH SETTLED)';
	...
	const CHEESE_CASH_SETTLED = 'CHEESE (CASH-SETTLED)';
	...
	const NASDAQ_100_STOCK_INDEX_MINI = 'NASDAQ-100 STOCK INDEX (MINI)';
